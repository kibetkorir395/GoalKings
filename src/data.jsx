...
export const pricings = [
	{
		...
		features: [
			...
			"Unrivaled Daily Slips — Tap into today’s highest-probability football predictions",
		],
		color: "#059212",
	},
	{
		...
		features: [
			...
			"7-Day VIP Coverage — Enjoy full, uninterrupted access to this week’s premium match breakdowns",
		],
		color: "#00A36C",
	},
	{
		...
		plan: "Monthly",
		billing: "Month",
		title: "Elite All-Access (Save 26%) — Comprehensive, top-tier analytics for dedicated fans.",
		price: 2100,
		features: [
			"Long-Range Match Planning — Formulate your betting strategy with our extended monthly projections",
			"30-Day VIP Pass — Enjoy completely unlimited, uninterrupted access to our premium network",
			"Your 30-Day Premium Edge — Establish a consistent, data-backed approach starting today",
		],
		color: "#0A6847",
	},
];
...
export const socialUrls = [
	{
		id: 1,
		icon: <IoLogoFacebook />,
		url: "https://www.facebook.com/share/1ETmmWvxHn/",
		title: "Facebook",
	},
	{
		id: 2,
	...
	},
	{
		id: 3,
		icon: <IoLogoWhatsapp />,
		url: "https://whatsapp.com/channel/0029VbAzC5EA89Mi4nOZRu0n",
		title: "WhatsApp",
	},
	{
		id: 4,
